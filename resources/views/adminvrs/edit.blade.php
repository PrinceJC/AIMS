                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">VEHICLE REQUISITION
                        ...
                        <form action="{{ route('adminvrs.update', $vehicles->id) }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="modal-body">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="recipient-name" class="col-form-label">Status</label>
                                        ...
                                        <option  selected>{{$vehicles->status}}</option>
                            ...
                            <div class="modal-footer">
                                <a href="/adminvrs"  class="btn btn-danger">BACK</a>
