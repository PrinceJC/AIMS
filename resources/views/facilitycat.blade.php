            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                     ...
                     <div class="card-body">
                    <h4 class="card-title">FACILITY CATEGORY
                        <br><br>
                        @if(count($errors) >0)
                        ...
                        @endif
                        <form action="{{ action('SampleController@addfacilitycat') }}" method="POST">

                            {{ csrf_field() }}
                            <div class="modal-body">
                                <label for="recipient-name" class="col-form-label">Enter Facility:</label>
                                <div class="col-md-8">
