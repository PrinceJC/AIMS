                  ...
                  <div class="card-body">
                    <h4 class="card-title">FACILITY RESERVATION
                        ...
                        <div class="float-right">
                            <a href="{{ route('facilities.create') }}" class="btn btn-lg btn-success" >Add FACILITY Reservation</a>
                          ...
                          <tr>
                            ...
                            <tr>
                                ...
                                <form action="{{route('facilities.destroy',$facility->id)}}" method="post">
                                    ...
                                    <td>
                                        <a href="{{route ('facilities.show', $facility->id)}} "  class="btn btn-warning" >SHOW</a>
                                        </td>
