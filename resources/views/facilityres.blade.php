...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">ADD FACILITY Reservation</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="{{ action('VehicleController@store') }}" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Approximate Distance Traveled: </label>
                    <input type="text" class="form-control" name="approxdistance">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Time of arrival:</label>
                    <input type="text" class="form-control" name="timearrival">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Time of Departure location</label>
                    <input type="text" class="form-control"name="timedeparturelocation" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Issued by Office from stock</label>
                    <input type="text" class="form-control" name="officestock">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Purchased During Trip</label>
                    <input type="text" class="form-control"name="purchased" >
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Used During the Trip</label>
                ...
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Gear Oil Issued</label>
                    <input type="text" class="form-control" name="gearoilissued">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">lub Oil Issued</label>
                    <input type="text" class="form-control" name="luboilissued">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Grease Issued</label>
                    <input type="text" class="form-control"name="greaseissued" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Odometer End of trip</label>
                    <input type="text" class="form-control"name="odometerend" >
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Distance Travelled</label>
