                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">VEHICLE RESERVATION
                        ...
                        <form action="{{ route('adminveh.update', $vehicle->id) }}" enctype="multipart/form-data" method="POST">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="modal-body">
                                ...
                                <div class="form-group col-md-6">
                                        ...
                                        <label for="recipient-name" class="col-form-label">Driver Name:</label>
                                            ...
                                            <option selected>{{ $vehiclee[0]->driver_name }}</option>
                                             @foreach ($veh as $vehs )
                                  ...
                                  <option selected>{{ $vehicle->vehicle_name }}</option>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <br>
                                  <label for="recipient-name" class="col-form-label">Remarks for Disapproval:</label>
                                  <div class="col-md-8">
                                      <input type="text" name="remarks" class="form-control input-lg">
                                  </div>
                            </div>
